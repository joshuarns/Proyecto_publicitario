          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 32, marginBottom: 40 }}>
            <div style={{ gridColumn: 'span 2' }}>
              <div style={{ marginBottom: 16 }}>
                <img src={logo} alt="Proyecto Publicitario" style={{ height: 44 }} />
              </div>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                {['f', 'ig', 'in'].map(s => (
                  <a key={s} href="#" style={{ width: 36, height: 36, background: '#1F2937', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 700, color: '#9CA3AF', textDecoration: 'none' }}>
                    {s}
                  </a>
                ))}
              </div>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                {['Páginas Web', 'Publicidad Online', 'Diseño Gráfico', 'Hospedaje Web', 'Email Profesional'].map(s => (
                  <a key={s} href="#" style={{ color: '#9CA3AF', textDecoration: 'none', fontSize: 14 }}>{s}</a>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10, fontSize: 14 }}>
                ...
                <span>📧 hola@proyectopublicitario.com</span>
